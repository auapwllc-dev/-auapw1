...
const BRAND_LOGOS = {
  "Acura": '<svg viewBox="0 0 100 100"><rect fill="currentColor" width="100" height="100" rx="8"/><text x="50" y="65" font-size="42" font-weight="bold" text-anchor="middle" fill="white" font-family="Arial">A</text></svg>',
  "Alfa Romeo": '<svg viewBox="0 0 100 100"><circle fill="currentColor" r="50" cx="50" cy="50"/><text x="50" y="65" font-size="40" font-weight="bold" text-anchor="middle" fill="white">AR</text></svg>',
  "Audi": '<svg viewBox="0 0 100 100"><rect fill="currentColor" width="100" height="100" rx="8"/><circle cx="25" cy="50" r="12" fill="none" stroke="white" stroke-width="3"/><circle cx="50" cy="50" r="12" fill="none" stroke="white" stroke-width="3"/><circle cx="75" cy="50" r="12" fill="none" stroke="white" stroke-width="3"/><circle cx="37.5" cy="35" r="12" fill="none" stroke="white" stroke-width="3"/><circle cx="62.5" cy="35" r="12" fill="none" stroke="white" stroke-width="3"/></svg>',
  "BMW": '<svg viewBox="0 0 100 100"><circle fill="currentColor" r="50" cx="50" cy="50"/><circle cx="50" cy="50" r="45" fill="none" stroke="white" stroke-width="4"/><line x1="50" y1="10" x2="50" y2="90" stroke="white" stroke-width="3"/><line x1="10" y1="50" x2="90" y2="50" stroke="white" stroke-width="3"/><circle cx="35" cy="35" r="12" fill="#1E40AF"/><circle cx="65" cy="35" r="12" fill="white"/><circle cx="35" cy="65" r="12" fill="white"/><circle cx="65" cy="65" r="12" fill="#1E40AF"/></svg>',
  "Buick": '<svg viewBox="0 0 100 100"><rect fill="currentColor" width="100" height="100" rx="8"/><text x="50" y="65" font-size="36" font-weight="bold" text-anchor="middle" fill="white">BUI</text></svg>',
  ...
  "Chevrolet": '<svg viewBox="0 0 100 100"><rect fill="currentColor" width="100" height="100" rx="8"/><g fill="white"><rect x="25" y="25" width="20" height="20"/><rect x="55" y="25" width="20" height="20"/><rect x="25" y="55" width="20" height="20"/><rect x="55" y="55" width="20" height="20"/></g></svg>',
  ...
  "Fiat": '<svg viewBox="0 0 100 100"><rect fill="currentColor" width="100" height="100" rx="8"/><text x="50" y="65" font-size="42" font-weight="bold" text-anchor="middle" fill="white" font-family="Arial">F</text></svg>',
  "Ford": '<svg viewBox="0 0 100 100"><rect fill="#003478" width="100" height="100" rx="8"/><text x="50" y="65" font-size="40" font-weight="bold" text-anchor="middle" fill="white" font-family="Arial" font-style="italic">F</text></svg>',
  "GMC": '<svg viewBox="0 0 100 100"><rect fill="currentColor" width="100" height="100" rx="8"/><text x="50" y="65" font-size="36" font-weight="bold" text-anchor="middle" fill="white">GMC</text></svg>',
  "Genesis": '<svg viewBox="0 0 100 100"><circle fill="currentColor" r="50" cx="50" cy="50"/><text x="50" y="65" font-size="32" font-weight="bold" text-anchor="middle" fill="white">GEN</text></svg>',
  "Honda": '<svg viewBox="0 0 100 100"><rect fill="currentColor" width="100" height="100" rx="8"/><text x="50" y="65" font-size="40" font-weight="bold" text-anchor="middle" fill="white">H</text></svg>',
  "Hummer": '<svg viewBox="0 0 100 100"><rect fill="#333333" width="100" height="100" rx="8"/><rect x="20" y="30" width="60" height="40" fill="none" stroke="white" stroke-width="3"/><rect x="25" y="35" width="14" height="14" fill="white"/><rect x="61" y="35" width="14" height="14" fill="white"/></svg>',
  ...
  "Isuzu": '<svg viewBox="0 0 100 100"><rect fill="currentColor" width="100" height="100" rx="8"/><text x="50" y="65" font-size="36" font-weight="bold" text-anchor="middle" fill="white">ISU</text></svg>',
  ...
  "Jeep": '<svg viewBox="0 0 100 100"><rect fill="currentColor" width="100" height="100" rx="8"/><circle cx="30" cy="40" r="8" fill="white"/><circle cx="70" cy="40" r="8" fill="white"/><circle cx="30" cy="70" r="8" fill="white"/><circle cx="70" cy="70" r="8" fill="white"/><line x1="30" y1="48" x2="30" y2="62" stroke="white" stroke-width="2"/><line x1="70" y1="48" x2="70" y2="62" stroke="white" stroke-width="2"/></svg>',
  "Kia": '<svg viewBox="0 0 100 100"><circle fill="currentColor" r="50" cx="50" cy="50"/><path d="M35 35 Q50 25 65 35 Q55 45 50 50 Q45 45 35 35" fill="white"/><path d="M35 65 Q50 75 65 65" fill="none" stroke="white" stroke-width="3" stroke-linecap="round"/></svg>',
  "Land Rover": '<svg viewBox="0 0 100 100"><rect fill="currentColor" width="100" height="100" rx="8"/><text x="50" y="65" font-size="28" font-weight="bold" text-anchor="middle" fill="white">ROVER</text></svg>',
  "Lexus": '<svg viewBox="0 0 100 100"><circle fill="currentColor" r="50" cx="50" cy="50"/><text x="50" y="65" font-size="40" font-weight="bold" text-anchor="middle" fill="white">L</text></svg>',
  ...
  "Mercedes-Benz": '<svg viewBox="0 0 100 100"><circle fill="currentColor" r="50" cx="50" cy="50"/><circle cx="50" cy="50" r="45" fill="none" stroke="white" stroke-width="3"/><line x1="50" y1="10" x2="50" y2="90" stroke="white" stroke-width="2"/><line x1="10" y1="50" x2="90" y2="50" stroke="white" stroke-width="2"/><circle cx="50" cy="50" r="6" fill="white"/></svg>',
  "Mercury": '<svg viewBox="0 0 100 100"><circle fill="currentColor" r="50" cx="50" cy="50"/><circle cx="50" cy="50" r="30" fill="none" stroke="white" stroke-width="3"/><circle cx="50" cy="50" r="10" fill="white"/></svg>',
  "Mini": '<svg viewBox="0 0 100 100"><rect fill="currentColor" width="100" height="100" rx="8"/><circle cx="50" cy="50" r="30" fill="none" stroke="white" stroke-width="3"/><circle cx="50" cy="50" r="10" fill="white"/></svg>',
  ...
  "Nissan": '<svg viewBox="0 0 100 100"><circle fill="currentColor" r="50" cx="50" cy="50"/><circle cx="50" cy="50" r="45" fill="none" stroke="white" stroke-width="3"/><text x="50" y="65" font-size="36" font-weight="bold" text-anchor="middle" fill="white">N</text></svg>',
  ...
  "Saturn": '<svg viewBox="0 0 100 100"><circle fill="currentColor" r="50" cx="50" cy="50"/><circle cx="50" cy="50" r="35" fill="none" stroke="white" stroke-width="2"/><circle cx="50" cy="50" r="20" fill="white"/></svg>',
  "Scion": '<svg viewBox="0 0 100 100"><rect fill="currentColor" width="100" height="100" rx="8"/><text x="50" y="65" font-size="38" font-weight="bold" text-anchor="middle" fill="white">S</text></svg>',
  ...
  "Suzuki": '<svg viewBox="0 0 100 100"><rect fill="currentColor" width="100" height="100" rx="8"/><text x="50" y="65" font-size="38" font-weight="bold" text-anchor="middle" fill="white">S</text></svg>',
  ...
  "Toyota": '<svg viewBox="0 0 100 100"><circle fill="currentColor" r="50" cx="50" cy="50"/><circle cx="50" cy="50" r="45" fill="none" stroke="white" stroke-width="2"/><ellipse cx="50" cy="45" rx="15" ry="20" fill="white"/><ellipse cx="50" cy="60" rx="18" ry="15" fill="white"/></svg>',
  "Volkswagen": '<svg viewBox="0 0 100 100"><circle fill="currentColor" r="50" cx="50" cy="50"/><circle cx="50" cy="50" r="45" fill="none" stroke="white" stroke-width="2"/><text x="50" y="65" font-size="36" font-weight="bold" text-anchor="middle" fill="white">VW</text></svg>',
          ...
          {filtered.map(b=>{
            ...
            return(
              <div key={b} onClick={()=>goTo("brand",b)} style={{display:"flex",flexDirection:"column",alignItems:"center",gap:5,padding:6,borderRadius:7,cursor:"pointer",transition:"all .3s",border:"1px solid "+tok.bdd,background:tok.card}} onMouseEnter={e=>{e.currentTarget.style.transform="translateY(-4px)";e.currentTarget.style.borderColor="rgba(232,232,232,.22)";}} onMouseLeave={e=>{e.currentTarget.style.transform="none";e.currentTarget.style.borderColor=tok.bdd;}}>
                <div style={{width:"100%",height:42,borderRadius:5,background:"linear-gradient(135deg,"+c+","+c+"88)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:24}} dangerouslySetInnerHTML={{__html:BRAND_LOGOS[b]||'<text x="50" y="65" font-size="36" fill="white">'+(b.slice(0,3).toUpperCase())+'</text>'}}></div>
      ...
      <div style={{padding:"12px 24px",display:"flex",alignItems:"center",gap:12,overflowX:"auto",maskImage:"linear-gradient(90deg,transparent,black 10%,black 90%,transparent)",webkitMaskImage:"linear-gradient(90deg,transparent,black 10%,black 90%,transparent)"}}>
        {luxuryBrands.map(b=>(
          <div key={b} style={{display:"flex",alignItems:"center",gap:6,padding:"6px 12px",background:"rgba(255,255,255,.05)",borderRadius:6,whiteSpace:"nowrap",fontSize:13,fontWeight:700,color:"rgba(255,255,255,.7)",fontFamily:"DM Mono"}}>
            <div style={{width:16,height:16,display:"flex",alignItems:"center",justifyContent:"center"}} dangerouslySetInnerHTML={{__html:BRAND_LOGOS[b]||'<text x="8" y="12" font-size="12" fill="white">⭐</text>'}}></div>
            <span>{b}</span>
          </div>
        ))}
      </div>
          ...
          {MAKES.map(function(b){
            ...
            return(
              <div key={b} onClick={()=>goTo("brand",b)} style={{display:"flex",flexDirection:"column",alignItems:"center",gap:5,padding:8,borderRadius:7,cursor:"pointer",transition:"all .3s",border:"1px solid "+tok.bdd,background:tok.card}} onMouseEnter={e=>{e.currentTarget.style.transform="translateY(-4px)";e.currentTarget.style.borderColor="rgba(232,232,232,.22)";}} onMouseLeave={e=>{e.currentTarget.style.transform="none";e.currentTarget.style.borderColor=tok.bdd;}}>
                <div style={{width:"100%",height:44,borderRadius:5,background:"linear-gradient(135deg,"+c+","+c+"88)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:22}} dangerouslySetInnerHTML={{__html:BRAND_LOGOS[b]||'<text x="50" y="65" font-size="32" fill="white">'+(b.slice(0,3).toUpperCase())+'</text>'}}></div>
